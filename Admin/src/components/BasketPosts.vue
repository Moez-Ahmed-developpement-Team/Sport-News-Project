...
<script>
    ...
    return{
      ...
      methods: {
        getBasketBallPosts() {
      axios.get(`http://localhost:3000/getOnePost/basketball`).then((result) => {console.log(result),this.Allposts=result.data}).catch((err) => console.log(err))
    },
    getComments(id){
    console.log(id);
